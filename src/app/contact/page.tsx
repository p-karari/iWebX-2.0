              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-yellow-400/10 to-yellow-300/10 rounded-xl flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex space-x-4">
                    {[
                      ...
                      <a
                        key={social.name}
                        href="#"
                        className="w-10 h-10 bg-gray-100 hover:bg-yellow-400 rounded-full flex items-center justify-center transition-all group transform hover:scale-110"
                      >
              ...
              <div className="bg-gray-50 rounded-2xl p-8 shadow-lg">
                ...
                <form ref={form} onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-yellow-400 to-yellow-300 hover:from-yellow-300 hover:to-yellow-400 text-gray-900 font-semibold py-4 px-6 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  >
